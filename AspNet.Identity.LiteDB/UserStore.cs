...
namespace AspNet.Identity.LiteDB
{
        ...
        where TUser : IdentityUser, new()
    {
        ...
        public UserStore(LiteCollection<TUser> users)
        {
            _Users = users;
        }
        ...
        {
            return Task.FromResult(_Users.FindOne(u => u.UserName == userName));
        }
        ...
        {
            return Task.FromResult(_Users.FindOne(u => u.Email == email));
        }
        ...
        public virtual IQueryable<TUser> Users => _Users.FindAll().AsQueryable();
    }
}